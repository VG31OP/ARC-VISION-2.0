...
from arcvision.const import CONFIG_DIR, FACE_DIR, PROCESS_PRIORITY_HIGH
...
from arcvision.util.classification import kickoff_model_training
from arcvision.util.path import safe_join
...
class EmbeddingProcess(ArcVisionProcess):
    def __init__(
        self,
        ...
        super().__init__(
            ...
            name="arcvision.embeddings_manager",
            daemon=True,
        )
        self.config = config
