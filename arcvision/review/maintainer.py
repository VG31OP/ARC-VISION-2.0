...
from arcvision.comms.review_updater import ReviewDataPublisher
...
from arcvision.track.object_processing import ManualEventState
from arcvision.util.image import SharedMemoryFrameManager, calculate_16_9_crop
...
class ReviewSegmentMaintainer(threading.Thread):
    ...
    def __init__(self, config: ArcVisionConfig, stop_event: MpEvent):
