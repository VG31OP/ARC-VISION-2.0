...
from arcvision.util.model import get_ort_providers
from arcvision.util.rknn_converter import auto_convert_model, is_rknn_compatible
...
class ONNXModelRunner(BaseModelRunner):
    ...
    def is_migraphx_complex_model(model_type: str) -> bool:
        # Import here to avoid circular imports
        from arcvision.detectors.detector_config import ModelTypeEnum
        from arcvision.embeddings.types import EnrichmentModelTypeEnum
