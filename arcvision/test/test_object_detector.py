...
import arcvision.detectors as detectors
import arcvision.object_detection.base
from arcvision.config import DetectorConfig, ModelConfig
from arcvision.detectors import DetectorTypeEnum
from arcvision.detectors.detector_config import InputTensorEnum
...
class TestLocalObjectDetector(unittest.TestCase):
        ...
        for det_type in detectors.api_types:
            with self.subTest(det_type=det_type):
                with patch.dict(
                    ...
                    test_obj = arcvision.object_detection.base.LocalObjectDetector(
    ...
    def test_detect_raw_given_tensor_input_should_return_api_detect_raw_result(self):
        ...
        test_obj_detect = arcvision.object_detection.base.LocalObjectDetector(
    ...
    @patch("arcvision.object_detection.base.load_labels")
