...
from arcvision.config import GenAIConfig, GenAIProviderEnum
...
class TestOllamaProvider(unittest.TestCase):
    ...
    def _run_with_response(self, client, response, messages):
        ...
        with patch(
            "arcvision.genai.plugins.ollama.OllamaAsyncClient",
    ...
    def test_normalize_multimodal_content(self):
        from arcvision.genai.plugins.ollama import _normalize_multimodal_content
...
class TestLlamaCppProvider(unittest.TestCase):
    ...
    def _run_with_lines(self, client, lines, messages):
        with patch(
            "arcvision.genai.plugins.llama_cpp.httpx.AsyncClient",
