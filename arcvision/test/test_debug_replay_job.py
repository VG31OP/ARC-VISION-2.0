...
from arcvision.jobs.debug_replay import (
    DebugReplayJob,
    NoRecordingsError,
...
from arcvision.jobs.manager import _completed_jobs, _current_jobs
...
class TestStartDebugReplayJob(unittest.TestCase):
    ...
    def test_rejects_when_no_recordings(self) -> None:
        ...
        with patch("arcvision.jobs.debug_replay.query_recordings", return_value=empty_qs):
    ...
    def test_returns_job_id_and_marks_session_starting(self) -> None:
        ...
        with (
            patch(
                "arcvision.jobs.debug_replay.query_recordings",
                return_value=self.recordings_qs,
            ),
            patch(
                "arcvision.jobs.debug_replay.run_ffmpeg_with_progress",
...
class TestRunnerHappyPath(unittest.TestCase):
    ...
    def test_progress_callback_updates_job_percent(self) -> None:
        ...
        from arcvision.jobs.manager import get_current_job
