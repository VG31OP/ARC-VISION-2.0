...
from arcvision.util.services import get_amd_gpu_stats, get_intel_gpu_stats
...
class TestGpuStats(unittest.TestCase):
    ...
    @patch("arcvision.stats.intel_gpu_info.intel_gpu_name_resolver.get_names")
    @patch("arcvision.util.services.time.sleep")
    @patch("arcvision.util.services.time.monotonic")
    @patch("arcvision.util.services._read_intel_drm_fdinfo")
    @patch("arcvision.util.services._enumerate_drm_devices")
    ...
    @patch("arcvision.util.services._read_intel_drm_fdinfo")
    @patch("arcvision.util.services._enumerate_drm_devices")
    @patch("arcvision.util.services._resolve_intel_gpu_pdev")
