...
from arcvision.config.camera.profile import CameraProfileConfig
from arcvision.config.profile import ProfileDefinitionConfig
from arcvision.config.profile_manager import PERSISTENCE_FILE, ProfileManager
...
class TestCameraProfileConfig(unittest.TestCase):
    ...
    def test_invalid_section_key_rejected(self):
        """Unknown section keys are rejected (extra=forbid from ArcVisionBaseModel)."""
        from pydantic import ValidationError
...
class TestProfileInConfig(unittest.TestCase):
    ...
    def test_profiles_parse(self):
        ...
        config = ArcVisionConfig(**self.base_config)
...
class TestProfileManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = ArcVisionConfig(**self.config_data)
    ...
    def test_activate_profile_adds_zone(self, mock_persist):
        ...
        from arcvision.config.camera.zone import ZoneConfig
    ...
    def test_update_config_preserves_runtime_state_with_active_profile(
        ...
        new_config = ArcVisionConfig(**self.config_data)
