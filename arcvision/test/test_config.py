...
from arcvision.config import BirdseyeModeEnum, ArcVisionConfig
from arcvision.const import MODEL_CACHE_DIR
from arcvision.detectors import DetectorTypeEnum
from arcvision.util.builtin import deep_merge
...
class TestConfig(unittest.TestCase):
    ...
    def test_config_class(self):
        frigate_config = ArcVisionConfig(**self.minimal)
    ...
    @patch("arcvision.detectors.detector_config.load_labels")
    def test_detector_custom_model_path(self, mock_labels):
        ...
        frigate_config = ArcVisionConfig(**(deep_merge(config, self.minimal)))
    ...
    def test_invalid_mqtt_config(self):
        ...
        self.assertRaises(ValidationError, lambda: ArcVisionConfig(**config))
    ...
    def test_inherit_tracked_objects(self):
        ...
        frigate_config = ArcVisionConfig(**config)
    ...
    def test_fails_on_missing_role(self):
        ...
        self.assertRaises(ValueError, lambda: ArcVisionConfig(**config))
    ...
    def test_fails_on_bad_camera_name(self):
        ...
        self.assertRaises(ValidationError, lambda: ArcVisionConfig(**config).cameras)
    ...
    def test_fails_on_bad_segment_time(self):
        ...
        self.assertRaises(
            ValueError,
            lambda: ArcVisionConfig(**config).ffmpeg.output_args.record,
        )
    ...
    def test_fails_zone_defines_untracked_object(self):
        ...
        self.assertRaises(ValueError, lambda: ArcVisionConfig(**config).cameras)
    ...
    def test_fails_duplicate_keys(self):
        ...
        self.assertRaises(
            DuplicateKeyError, lambda: ArcVisionConfig.parse_yaml(raw_config)
        )
...
class TestAttributeFilterDefaults(unittest.TestCase):
    ...
    def _build_config(self, object_filters: dict | None = None) -> ArcVisionConfig:
        config = deep_merge({}, self.minimal)
        if object_filters is not None:
            config.setdefault("objects", {})["filters"] = object_filters
        return ArcVisionConfig(**config)
