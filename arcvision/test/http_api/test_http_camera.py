...
class TestDeleteCameraRuntimeConfig(BaseTestHttp):
    ...
    def _create_app_with_dispatcher(self, dispatcher):
        ...
        from arcvision.api.auth import get_allowed_cameras_for_filter, get_current_user
        ...
        app = create_fastapi_app(
            ArcVisionConfig(**self.minimal_config),
            self.db,
            None,
            None,
            None,
    ...
    @patch("arcvision.api.camera.requests.delete")
    @patch("arcvision.api.camera.cleanup_camera_files")
    @patch("arcvision.api.camera.cleanup_camera_db")
    @patch("arcvision.api.camera.find_config_file")
