...
from arcvision.config.camera.ffmpeg import FFMPEG_INPUT_ARGS_DEFAULT
...
class TestFfmpegPresets(unittest.TestCase):
    ...
    def test_default_ffmpeg_input_arg_preset(self):
        ...
        frigate_preset_config = ArcVisionConfig(**self.default_ffmpeg)
        assert (
