...
from arcvision.comms.detections_updater import DetectionPublisher, DetectionTypeEnum
from arcvision.comms.inter_process import InterProcessRequestor
from arcvision.config import CameraConfig, CameraInput, ArcVisionConfig
from arcvision.config.camera.ffmpeg import CameraFfmpegConfig
...
from arcvision.data_processing.common.audio_transcription.model import (
    AudioTranscriptionModelRunner,
)
from arcvision.data_processing.real_time.audio_transcription import (
    AudioTranscriptionRealTimeProcessor,
)
from arcvision.ffmpeg_presets import parse_preset_input
from arcvision.log import LogPipe, suppress_stderr_during
from arcvision.util.builtin import get_ffmpeg_arg_list, load_labels
from arcvision.util.ffmpeg import start_or_restart_ffmpeg, stop_ffmpeg
...
class AudioProcessor(ArcVisionProcess):
    name = "arcvision.audio_manager"
    ...
    def __init__(
        ...
        super().__init__(
            stop_event, PROCESS_PRIORITY_HIGH, name="arcvision.audio_manager", daemon=True
        )
