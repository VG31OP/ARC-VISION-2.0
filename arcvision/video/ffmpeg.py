...
class CameraCapture(ArcVisionProcess):
    def __init__(
        self,
        config: CameraConfig,
        shm_frame_count: int,
        ...
        super().__init__(
            ...
            name=f"arcvision.capture:{config.name}",
            daemon=True,
        )
        self.config = config
        self.shm_frame_count = shm_frame_count
