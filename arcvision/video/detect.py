...
from arcvision.config import CameraConfig, DetectConfig, LoggerConfig, ModelConfig
...
from arcvision.motion import MotionDetector
from arcvision.motion.improved_motion import ImprovedMotionDetector
from arcvision.object_detection.base import RemoteObjectDetector
from arcvision.ptz.autotrack import ptz_moving_at_frame_time
from arcvision.track import ObjectTracker
from arcvision.track.norfair_tracker import NorfairTracker
from arcvision.track.tracked_object import TrackedObjectAttribute
from arcvision.util.builtin import EventsPerSecond
from arcvision.util.image import (
    FrameManager,
    SharedMemoryFrameManager,
    draw_box_with_label,
)
from arcvision.util.object import (
    create_tensor_input,
...
from arcvision.util.time import get_tomorrow_at_time

logger = logging.getLogger(__name__)


class CameraTracker(ArcVisionProcess):
    def __init__(
        self,
        config: CameraConfig,
        ...
        super().__init__(
            stop_event,
            PROCESS_PRIORITY_HIGH,
            name=f"arcvision.process:{config.name}",
            daemon=True,
        )
        self.config = config
