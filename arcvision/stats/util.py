...
from arcvision.const import CACHE_DIR, CLIPS_DIR, RECORD_DIR
...
from arcvision.types import StatsTrackingTypes
...
def get_latest_version(config: ArcVisionConfig) -> str:
...
async def set_bandwidth_stats(config: ArcVisionConfig, all_stats: dict[str, Any]) -> None:
...
async def set_npu_usages(config: ArcVisionConfig, all_stats: dict[str, Any]) -> None:
    stats: dict[str, dict] = {}
