...
from arcvision.api.defs.query.review_query_parameters import (
    ReviewActivityMotionQueryParams,
    ReviewQueryParams,
    ReviewSummaryQueryParams,
)
from arcvision.api.defs.request.review_body import ReviewModifyMultipleBody
from arcvision.api.defs.response.generic_response import GenericResponse
from arcvision.api.defs.response.review_response import (
...
from arcvision.models import Recordings, ReviewSegment, UserReviewStatus
from arcvision.review.types import SeverityEnum
from arcvision.util.time import get_dst_transitions
...
def motion_activity(
    ...
    df.index = df.index.astype("datetime64[s]").astype("int64")
