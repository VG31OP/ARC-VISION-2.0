...
from arcvision.api.chat_util import (
    chunk_content,
    distance_to_score,
...
from arcvision.api.defs.query.events_query_parameters import EventsQueryParams
from arcvision.api.defs.request.chat_body import ChatCompletionRequest
from arcvision.api.defs.response.chat_response import (
    ChatCompletionResponse,
    ChatMessageResponse,
    ToolCall,
)
from arcvision.api.defs.tags import Tags
from arcvision.api.event import _build_attribute_filter_clause, events
from arcvision.config import ArcVisionConfig
from arcvision.config.classification import SemanticSearchModelEnum
from arcvision.genai.prompts import (
    build_chat_system_prompt,
    get_attribute_classifications,
    get_tool_definitions,
)
from arcvision.genai.utils import build_assistant_message_for_conversation
from arcvision.jobs.vlm_watch import (
    get_vlm_watch_job,
    start_vlm_watch_job,
    stop_vlm_watch_job,
)
...
def _embeddings_language(config: ArcVisionConfig) -> Literal["english", "multi"]:
...
def _execute_get_recap(
    ...
    from arcvision.models import ReviewSegment
