...
from arcvision.api.config_util import swap_runtime_config
from arcvision.api.defs.request.app_body import CameraSetBody
...
from arcvision.models import User
from arcvision.util.builtin import clean_camera_user_pass, get_record_segment_time
from arcvision.util.camera_cleanup import cleanup_camera_db, cleanup_camera_files
from arcvision.util.config import find_config_file
from arcvision.util.image import run_ffmpeg_snapshot
...
async def delete_camera(
    ...
    """
    frigate_config: ArcVisionConfig = request.app.frigate_config
