...
from arcvision.api import app as main_app
from arcvision.api import (
    auth,
    camera,
    chat,
    classification,
...
from arcvision.api.auth import get_jwt_secret, limiter, require_admin_by_default
...
from arcvision.debug_replay import DebugReplayManager, debug_replay_auto_stop_watchdog
...
def create_fastapi_app(
    frigate_config: ArcVisionConfig,
