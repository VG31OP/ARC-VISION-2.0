...
from arcvision.config import DetectConfig, ModelConfig
...
from arcvision.detectors.detector_config import PixelFormatEnum
from arcvision.models import Event, Regions, Timeline
