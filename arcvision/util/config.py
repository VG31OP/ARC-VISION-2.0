...
def find_config_file() -> str:
    config_path = (
        os.environ.get("ARC_VISION_CONFIG_FILE")
        or os.environ.get("CONFIG_FILE")
        or os.environ.get("FRIGATE_CONFIG_FILE", DEFAULT_CONFIG_FILE)
    )
...
def apply_section_update(camera_config, section: str, update: dict) -> str | None:
    ...
    are recomputed.  This mirrors the logic in ArcVisionConfig.post_validation.
