...
from arcvision.util.builtin import clean_camera_user_pass, escape_special_characters
...
def get_cpu_stats() -> dict[str, dict]:
    ...
    usages["arcvision.full_system"] = {
        "cpu": str(system_cpu),
        "mem": str(system_mem.percent),
    }

    keywords = ["ffmpeg", "go2rtc", "arcvision.", "python3"]
...
def _idle_intel_gpu_stats(
    ...
    """
    from arcvision.stats.intel_gpu_info import intel_gpu_name_resolver
