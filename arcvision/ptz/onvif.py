...
from arcvision.config import ArcVisionConfig, ZoomingModeEnum
from arcvision.config.camera.updater import (
    CameraConfigUpdateEnum,
    CameraConfigUpdateSubscriber,
)
from arcvision.util.builtin import find_by_key
...
class OnvifController:
    ...
    def __init__(
        self, config: ArcVisionConfig, ptz_metrics: dict[str, PTZMetrics]
    ) -> None:
