...
from arcvision.util.process import ArcVisionProcess, ArcVisionProcess
...
class MonitoredProcess:
    ...
    name: str
    process: ArcVisionProcess
    factory: Callable[[], ArcVisionProcess]
    on_restart: Callable[[ArcVisionProcess], None] | None = None
...
class ArcVisionWatchdog(threading.Thread):
    def __init__(
        self,
        detectors: dict[str, ObjectDetectProcess],
        stop_event: MpEvent,
    ):
        super().__init__(name="arcvision_watchdog")
    ...
    def register(
        ...
        """Register a ARC VISION process for monitoring and automatic restart."""
...
FrigateWatchdog = ArcVisionWatchdog
