...
from arcvision.util.config import resolve_ffmpeg_path
...
class FfmpegOutputArgsConfig(ArcVisionBaseModel):
...
class FfmpegConfig(ArcVisionBaseModel):
    path: str = Field(
        default="default",
        title="FFmpeg path",
...
class CameraInput(ArcVisionBaseModel):
