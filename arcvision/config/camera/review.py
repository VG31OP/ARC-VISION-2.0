...
class AlertsConfig(ArcVisionBaseModel):
    """Configure alerts"""
...
class DetectionsConfig(ArcVisionBaseModel):
...
class GenAIReviewConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
...
class ReviewConfig(ArcVisionBaseModel):
