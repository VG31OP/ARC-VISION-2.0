...
class AudioTranscriptionConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
...
class BirdClassificationConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
...
class CustomClassificationStateCameraConfig(ArcVisionBaseModel):
...
class CustomClassificationStateConfig(ArcVisionBaseModel):
...
class CustomClassificationObjectConfig(ArcVisionBaseModel):
...
class CustomClassificationConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=True,
        title="Enable model",
...
class ClassificationConfig(ArcVisionBaseModel):
...
class SemanticSearchConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
...
class TriggerConfig(ArcVisionBaseModel):
...
class CameraSemanticSearchConfig(ArcVisionBaseModel):
...
class FaceRecognitionConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
...
class CameraFaceRecognitionConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
        title="Enable face recognition",
...
class ReplaceRule(ArcVisionBaseModel):
    pattern: str = Field(..., title="Regex pattern")
    replacement: str = Field(..., title="Replacement string")


class LicensePlateRecognitionConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
        title="Enable LPR",
...
class CameraLicensePlateRecognitionConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
        title="Enable LPR",
...
class CameraAudioTranscriptionConfig(ArcVisionBaseModel):
    enabled: bool = Field(
        default=False,
