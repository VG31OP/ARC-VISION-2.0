...
from arcvision.config.camera.genai import GenAIConfig, GenAIRoleEnum
...
class GenAIClientManager:
    ...
    def update_config(self, config: ArcVisionConfig) -> None:
    ...
    def _get_client(self, name: str) -> "GenAIClient | None":
        ...
        from arcvision.genai import PROVIDERS
