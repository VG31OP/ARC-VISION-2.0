...
from arcvision.comms.embeddings_updater import EmbeddingsRequestEnum
...
from arcvision.const import FACE_DIR, MODEL_CACHE_DIR
from arcvision.data_processing.common.face.model import (
    ArcFaceRecognizer,
    FaceNetRecognizer,
    FaceRecognizer,
)
...
from arcvision.util.image import area
