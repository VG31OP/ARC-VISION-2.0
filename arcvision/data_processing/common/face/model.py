...
from arcvision.embeddings.onnx.face_embedding import ArcfaceEmbedding, FaceNetEmbedding
from arcvision.log import redirect_output_to_logger
...
class FaceNetRecognizer(FaceRecognizer):
    def __init__(self, config: ArcVisionConfig):
